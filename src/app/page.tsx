...
const phases = [
  ...
  {
    name: "Phase 4 — Matchday & Beyond", dates: "Jun 13 – Jun 27", status: "active" as const, progress: 75, owner: "Full Team",
    tasks: [
      ...
      { name: "Match 1: UZB 1–3 COL — Jun 17, Azteca (Fayzullaev 60' historic first WC goal)", done: true },
      { name: "Match 2: UZB 0–5 POR — Jun 23, NRG Houston (Ronaldo ×2)", done: true },
      { name: "i18n full audit — 30+ routes, 3 languages, all raw keys fixed", done: true },
      { name: "Watch party reminder bot job scheduled (Jun 27 21:30 UTC)", done: true },
      { name: "Ticket swap section, /explore, Fan of the Day, AI floating btn", done: true },
      { name: "Group K standings + DR Congo preview + must-win card on /matches", done: true },
      { name: "Match 3: DR Congo — Jun 27, Mercedes-Benz Stadium Atlanta", done: false },
    ],
  },
];
...
const completedWork = [
  ...
  {
    category: "🌐 Website — Jun 24",
    items: [
      "Match results live: UZB 1–3 COL, UZB 0–5 POR with scorers & key moments",
      "Group K standings table with live data fallback",
      "DR Congo opponent preview + What the Wolves Need card on /matches",
      "Must-win urgency pill on home NextMatchCard",
      "Ticket Swap section on /tickets (peer-to-peer via Telegram)",
      "/explore page + Ko'proq footer column — 8 hidden hubs surfaced",
      "Fan of the Day card on homepage + /fan-wall",
      "Floating AI button on /matches + /squad with pre-filled questions",
      "Toshkentda Davra — 10 verified venues with phones, badges, booking info",
    ],
  },
  {
